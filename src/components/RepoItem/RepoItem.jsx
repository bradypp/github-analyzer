...
// Class component used in order for FlipMove animations to work
        ...
        return (
            <a
                ...
                <li className="repo-item">
                    ...
                    {description && (
                        <p className="repo-item__description">{this.getDescription()}</p>
                    )}
                    ...
                    <div className="repo-item__attributes repo-item__attributes--2">
                        ...
                        <div className="repo-item__attributes__size">{this.calculateSize()} </div>
                    </div>
                </li>
            </a>
        );
